...
info "Usuwam stare PVC i PV (jeśli istnieją)..."
kubectl delete pvc --all -n "$NAMESPACE" || true
kubectl delete pv $(kubectl get pv -o name | grep jenkins) || true
...
echo "[OK] Jenkins został zainstalowany bez persistent storage!"
